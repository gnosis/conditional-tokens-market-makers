...
contract LMSRMarketMakerFactory {
    ...
    function createLMSRMarketMaker(ConditionalTokens pmSystem, IERC20 collateralToken, bytes32[] memory conditionIds, uint64 fee, Whitelist whitelist, uint funding)
        public
